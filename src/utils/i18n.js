...
const translations = {
    fr: {
        ...
        'settings.blocs.weatherCards': 'Température, Humidité, Pression',
        'settings.blocs.precipitation': 'Précipitations',
        'settings.blocs.wind': 'Vent',
        'settings.blocs.sunMoon': 'Soleil & Lune',
        'settings.blocs.chart': 'Statistiques',
        'settings.blocs.mosaic': 'Statistiques détaillées',
        'settings.blocs.mosaic.detailed': 'Statistiques détaillées {range}',
        ...
        // Chart
        'chart.title': 'Aperçu',
        'chart.statistics': 'Statistiques {range}',
        ...
        'chart.series.precipRain': 'Pluie (par intervalle)',
        'chart.series.precipCheck': 'Précipitations (mm)',
        'chart.series.precipRate': 'Intensité (mm/h)',
        'chart.series.precipCum': 'Pluie (cumulée)',
        'chart.range.day': '24h',
        'chart.range.week': '7j',
        'chart.range.week': '7j',
    ...
    en: {
        ...
        'settings.blocs.weatherCards': 'Temperature, Humidity, Pressure',
        'settings.blocs.precipitation': 'Precipitation',
        'settings.blocs.wind': 'Wind',
        'settings.blocs.sunMoon': 'Sun & Moon',
        'settings.blocs.chart': 'Statistics',
        'settings.blocs.mosaic': 'Detailed Statistics',
        'settings.blocs.mosaic.detailed': 'Detailed Statistics {range}',
        ...
        'chart.statistics': 'Statistics {range}',
        ...
        'chart.series.precipRain': 'Rain (per interval)',
        'chart.series.precipCheck': 'Precipitation (mm)',
        'chart.series.precipRate': 'Intensity (mm/h)',
        'chart.series.precipCum': 'Rain (accumulated)',
        'chart.range.day': '24h',
        'chart.range.week': '7d',
        'chart.range.week': '7d',
