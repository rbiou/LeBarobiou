...
const translations = {
    fr: {
        ...
        'settings.weatherModel': 'Modèle Météo',
        'settings.weatherModel.auto': 'Automatique (Recommandé)',
        'settings.weatherModel.meteofrance_seamless': 'Météo-France (France, ~4j)',
        'settings.weatherModel.icon_seamless': 'DWD ICON (Europe, ~7j)',
        'settings.weatherModel.gfs_seamless': 'NOAA GFS (Monde, ~16j)',
        'settings.weatherModel.ecmwf_ifs04': 'ECMWF IFS (Monde, ~10j)',
        'settings.weatherModel.desc': 'Le modèle automatique choisit la meilleure source selon votre localisation. Certains modèles peuvent avoir moins de jours de prévisions.',
        ...
        'settings.blocs.forecast': 'Prévisions prochains jours',
        ...
        // Forecast
        'forecast.title': 'Prévisions prochains jours',
        'forecast.source': 'Source Open-Meteo',
        'forecast.autoExpand': "Déplier aujourd'hui",
        'forecast.morning': 'Matin',
        'forecast.afternoon': 'Après-midi',
        'forecast.clear': 'Ciel dégagé',
        'forecast.mainly_clear': 'Peu nuageux',
        'forecast.partly_cloudy': 'Partiellement nuageux',
        'forecast.overcast': 'Couvert',
        'forecast.fog': 'Brouillard',
        'forecast.drizzle': 'Bruine',
        'forecast.freezing_drizzle': 'Bruine verglaçante',
        'forecast.rain_slight': 'Pluie (faible)',
        'forecast.rain_moderate': 'Pluie (modérée)',
        'forecast.rain_heavy': 'Pluie (forte)',
        'forecast.freezing_rain': 'Pluie verglaçante',
        'forecast.snow_slight': 'Neige (faible)',
        'forecast.snow_moderate': 'Neige (modérée)',
        'forecast.snow_heavy': 'Neige (forte)',
        'forecast.snow_grains': 'Grésil',
        'forecast.rain_showers': 'Averses de pluie',
        'forecast.snow_showers': 'Averses de neige',
        'forecast.thunderstorm': 'Orage',
        'forecast.thunderstorm_hail': 'Orage avec grêle',
        'forecast.unknown': 'Inconnu',
        ...
        'precip.cumMonth': 'Ce mois',
        'precip.cum7d': '7 jours',
        'precip.last7days': 'Derniers 7 jours',
        'precip.cum30d': '30 jours',
        'precip.last30days': 'Derniers 30 jours',
        'precip.activeEvent': 'Pluie depuis',
        'precip.ongoing': 'Épisode en cours',
        'precip.eventDuration': 'Durée',
        'precip.eventDurationHelper': 'Depuis le début de la pluie',
        'precip.eventTotal': 'Cumul épisode',
        'precip.eventTotalHelper': 'Eau tombée pdt. cet épisode',
    ...
    en: {
        ...
        'settings.language.fr': 'Français',
        'settings.language.en': 'English',
        'settings.weatherModel': 'Weather Model',
        'settings.weatherModel.auto': 'Automatic (Recommended)',
        'settings.weatherModel.meteofrance_seamless': 'Meteo-France (France, ~4d)',
        'settings.weatherModel.icon_seamless': 'DWD ICON (Europe, ~7d)',
        'settings.weatherModel.gfs_seamless': 'NOAA GFS (Global, ~16d)',
        'settings.weatherModel.ecmwf_ifs04': 'ECMWF IFS (Global, ~10d)',
        'settings.weatherModel.desc': 'Automatic model chooses the best source based on your location. Some models may have fewer forecast days.',
        ...
        'settings.blocs.forecast': 'Next Days Forecast',
        ...
        'forecast.source': 'Source Open-Meteo',
        'forecast.autoExpand': 'Auto-expand Today',
        'forecast.morning': 'Morning',
        'forecast.afternoon': 'Afternoon',
        'forecast.clear': 'Clear sky',
        'forecast.mainly_clear': 'Mainly clear',
        'forecast.partly_cloudy': 'Partly cloudy',
        'forecast.overcast': 'Overcast',
        'forecast.fog': 'Fog',
        'forecast.drizzle': 'Drizzle',
        'forecast.freezing_drizzle': 'Freezing Drizzle',
        'forecast.rain_slight': 'Rain (slight)',
        'forecast.rain_moderate': 'Rain (moderate)',
        'forecast.rain_heavy': 'Rain (heavy)',
        'forecast.freezing_rain': 'Freezing Rain',
        'forecast.snow_slight': 'Snow (slight)',
        'forecast.snow_moderate': 'Snow (moderate)',
        'forecast.snow_heavy': 'Snow (heavy)',
        'forecast.snow_grains': 'Snow grains',
        'forecast.rain_showers': 'Rain showers',
        'forecast.snow_showers': 'Snow showers',
        'forecast.thunderstorm': 'Thunderstorm',
        'forecast.thunderstorm_hail': 'Thunderstorm with hail',
        ...
        'precip.cumMonth': 'This month',
        'precip.cum7d': '7 days',
        'precip.last7days': 'Last 7 days',
        'precip.cum30d': '30 days',
        'precip.last30days': 'Last 30 days',
        'precip.activeEvent': 'Raining for',
        'precip.ongoing': 'Ongoing Event',
        'precip.eventDuration': 'Duration',
        'precip.eventDurationHelper': 'Time since rain started',
        'precip.eventTotal': 'Event Total',
        'precip.eventTotalHelper': 'Water accumulated during event',
